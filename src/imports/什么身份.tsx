import svgPaths from "./svg-odwjgqbh47";
...
function Frame() {
  return (
    <div className="-translate-x-1/2 absolute content-stretch flex flex-col items-center justify-center left-[calc(50%-0.5px)] px-[30px] top-[109px] w-[374px]">
      <p className="font-['Hiragino_Sans:W7',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#0d0e12] text-[24px] w-full">なぜご利用を始めましたか？</p>
    </div>
  );
}
  ...
  return (
    <div className="absolute content-stretch flex flex-col gap-[20px] items-start left-[19px] top-[249px] w-[335px]">
      <div className="bg-[#f2fbff] h-[56px] relative rounded-[12px] shrink-0 w-full" data-name="Btn">
        ...
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex items-center justify-center px-[12px] relative size-full">
            <p className="font-['Hiragino_Sans:W4',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#0d0e12] text-[16px] text-center whitespace-nowrap">自分の学習のため（本人）</p>
          </div>
        </div>
      </div>
      <div className="bg-[#aee3fa] h-[56px] relative rounded-[12px] shrink-0 w-full" data-name="Btn">
        ...
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex items-center justify-center px-[12px] relative size-full">
            <p className="font-['Hiragino_Sans:W7',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#0d0e12] text-[16px] text-center whitespace-nowrap">子どもの学習のため（保護者）</p>
          </div>
        </div>
      </div>
    </div>
...
export default function Component() {
  return (
    <div className="bg-white relative size-full" data-name="什么身份">
