import svgPaths from "./svg-izsvku89y1";
...
function Frame() {
  return (
    <div className="-translate-x-1/2 absolute content-stretch flex flex-col gap-[10px] items-center justify-center leading-[normal] left-[calc(50%-0.5px)] not-italic px-[30px] text-[#0d0e12] top-[109px] w-[374px]">
      ...
      <div className="bg-[#aee3fa] h-[56px] relative rounded-[12px] shrink-0 w-full" data-name="Btn">
        ...
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex items-center justify-center px-[12px] relative size-full">
            <p className="font-['Hiragino_Sans:W7',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#0d0e12] text-[16px] text-center whitespace-nowrap">小学生</p>
          </div>
        </div>
      </div>
...
export default function M304PoopInfo() {
  return (
    <div className="bg-white relative size-full" data-name="M3.0.4_Poop Info">
