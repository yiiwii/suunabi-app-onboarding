...
import svgPaths from "./svg-ec1yw9kfne";
...
function Frame1() {
  ...
  return (
    <div className="absolute content-stretch flex flex-col gap-[20px] items-start left-[19px] top-[300px] w-[335px]">
      <button 
        onClick={() => navigate('/grade')}
        className="bg-[#f2fbff] h-[56px] relative rounded-[12px] shrink-0 w-full cursor-pointer" 
        data-name="Btn"
      >
        ...
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex items-center justify-center px-[12px] relative size-full">
            <p className="font-['Hiragino_Sans:W4',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#0d0e12] text-[16px] text-center whitespace-nowrap">小学生</p>
          </div>
        </div>
      </button>
      <button 
      ...
      >
        ...
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex items-center justify-center px-[12px] relative size-full">
            <p className="font-['Hiragino_Sans:W4',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#0d0e12] text-[16px] text-center whitespace-nowrap">中学生</p>
          </div>
        </div>
      </button>
      <button 
      ...
      >
        ...
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex items-center justify-center px-[12px] relative size-full">
            <p className="font-['Hiragino_Sans:W4',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#0d0e12] text-[16px] text-center whitespace-nowrap">高校生</p>
          </div>
        </div>
      </button>
      <button 
      ...
      >
        ...
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex items-center justify-center px-[12px] relative size-full">
            <p className="font-['Hiragino_Sans:W4',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#0d0e12] text-[16px] text-center whitespace-nowrap">大学生</p>
          </div>
        </div>
      </button>
      <button 
...
function Frame() {
  return (
    <div className="-translate-x-1/2 absolute content-stretch flex flex-col gap-[10px] items-center justify-center leading-[normal] left-[calc(50%-0.5px)] not-italic px-[30px] text-[#0d0e12] top-[109px] w-[376px]">
      <p className="font-['Hiragino_Sans:W7',sans-serif] relative shrink-0 text-[24px] w-full">今の学年を選んでください。</p>
      <p className="font-['Hiragino_Sans:W4',sans-serif] relative shrink-0 text-[16px] w-full">入力内容に合わせて、学習内容を用意します。</p>
    </div>
  );
}
...
export default function Quetion() {
  return (
    <div className="bg-white relative size-full" data-name="Quetion">
      ...
      <Info />
      <Frame1 />
      <div className="absolute h-[34px] left-[-1px] top-[778px] w-[375px]" data-name="滑动控件">
      ...
      <div className="absolute bg-white bottom-0 content-stretch flex flex-col gap-[8px] items-center left-[-1px] pt-[8px] w-[375px]" data-name="Bottom Navigation">
        <div className="bg-[#339bc9] content-stretch flex h-[56px] items-center justify-center opacity-30 px-[12px] relative rounded-[12px] shrink-0 w-[335px]" data-name="Btn">
          ...
          <p className="font-['Hiragino_Sans:W7',sans-serif] leading-[normal] not-italic relative shrink-0 text-[16px] text-center text-white whitespace-nowrap">次へ</p>
        </div>
